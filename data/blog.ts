    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Se o seu projeto exige comprovação formal de segurança e qualidade — comum em hotéis, redes e edifícios corporativos — dê preferência a equipamentos com certificações reconhecidas (CE, TÜV, ISO 9001) e que aceitem o conjunto completo de dispositivos de proteção: sensores de presença, fotocélulas e chave de segurança. É o caso da nossa linha AG400, que soma a isso roldanas com trava antiqueda.",
        ],
      },
      {
